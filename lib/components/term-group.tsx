...
import type {NimbusState, NimbusDispatch, TermGroupProps, TermGroupOwnProps} from '../../typings/nimbus';
...
const mapStateToProps = (state: NimbusState, ownProps: TermGroupOwnProps) => ({
  childGroups: ownProps.termGroup.children.map((uid) => state.termGroups.termGroups[uid])
});

const mapDispatchToProps = (dispatch: NimbusDispatch, ownProps: TermGroupOwnProps) => ({
