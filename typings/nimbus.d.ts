...
export type ITermGroupReducer = Reducer<ITermState, NimbusActions>;

export type IUiReducer = Reducer<uiState, NimbusActions>;

export type ISessionReducer = Reducer<sessionState, NimbusActions>;

import type {Middleware, Reducer} from 'redux';
export type NimbusPlugin = {
  getTabProps: any;
  getTabsProps: any;
  getTermGroupProps: any;
  getTermProps: any;
  mapHeaderDispatch: any;
  mapNimbusDispatch: any;
  mapNimbusTermDispatch: any;
  mapNotificationsDispatch: any;
  mapTermsDispatch: any;
  mapHeaderState: any;
  mapNimbusState: any;
  mapNimbusTermState: any;
...
export type NimbusDispatch = ReturnType<typeof configureStore>['dispatch'];
...
import type {NimbusConnectedProps} from '../lib/containers/nimbus';
export type NimbusProps = NimbusConnectedProps & extensionProps;
